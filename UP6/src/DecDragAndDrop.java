        ...
        MouseMotionListener // For processing mouse drags
{
    ...
    private ArrayList<Line> astroids = new ArrayList<>();
    // A list of Scribbles to draw
    private Line currentScribble; // The scribble in progress
    private Line beingDragged; // The scribble being dragged
    ...
    public void paintComponent(Graphics g) {
        ...
        MyStroke stroke = new MyStroke(); // Specify wide lines
        g2.setStroke(new BasicStroke(7.0f));
        for (Line astroid : astroids) {
			g2.draw(stroke.createStrokedShape(new Line(astroid.centerX, astroid.centerY, astroid.radius)));
        }
    ...
    public void mousePressed(MouseEvent e) {
        ...
        currentScribble = new Line(e.getX(), e.getY(), param);
    ...
    public void dragGestureRecognized(DragGestureEvent e) {
        ...
        for (Line astroid : astroids) { // Loop through the scribbles
            if (astroid.intersects(rectangle)) {
                ...
                Line dragScribble = (Line) astroid.clone();
    ...
    public void dragEnter(DropTargetDragEvent e) {
        if (e.isDataFlavorSupported(Line.decDataFlavor) || e.isDataFlavorSupported(DataFlavor.stringFlavor)) {
    ...
    public void drop(DropTargetDropEvent e) {
        ...
        Line droppedScribble; // This will hold the Scribble object

        // First, try to get the data directly as a scribble object
        try {
            droppedScribble = (Line) t.getTransferData(Line.decDataFlavor);
            ...
            try {
                ...
                droppedScribble = Line.getFromString(s);
            } catch (Exception ex2) {
        ...
        astroids.add(droppedScribble); // add to display list
