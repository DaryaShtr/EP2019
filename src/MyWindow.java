...
public class MyWindow extends Applet implements Runnable{
		...
		private volatile boolean fSuspend = false;
	  	...
	  	int recBorderWidth = 35;
	  	int ovalBorderWidth = 15;
	  	Thread t = null;
...
//	    		}
		...
		public void paint(Graphics g){
	    	MyRectangle rect = new MyRectangle(xShape, yShape, shapeWidth, shapeHight, recBorderWidth, recColor, recBorderColor);
	    	MyOval oval = new MyOval(xShape, yShape, shapeWidth, shapeHight, ovalBorderWidth, ovalColor, ovalBorderColor);
